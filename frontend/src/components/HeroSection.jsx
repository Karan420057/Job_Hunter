  ...
  return (
    <div className='text-center'>
        <div className='flex flex-col gap-5 my-10'>
            ...
            <p>Opportunities don’t come looking for talent — talent builds the path to opportunity.</p>
            <div className='flex w-[40%] shadow-lg border border-gray-200 pl-3 rounded-full items-center gap-4 mx-auto'>
                ...
                <Button onClick={searchJobHandler} className='rounded-r-full bg-[#6a38c2]'><Search className='h-5 w-5' /></Button>
            </div>
        </div>
    </div>
  )
